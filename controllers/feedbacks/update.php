        ...
        <div class="form-buttons">
            <div class="loading-indicator-container">
                <button
                    ...
                    data-load-indicator="<?= e(trans('backend::lang.form.saving_name', ['name' => trans('webmaxx.forms::lang.models.feedback.label')])); ?>"
                ...
                <button
                    ...
                    data-load-indicator="<?= e(trans('backend::lang.form.deleting_name', ['name' => trans('webmaxx.forms::lang.models.feedback.label')])); ?>"
                    data-request-confirm="<?= e(trans('backend::lang.form.confirm_delete')); ?>">
                </button>
                <span class="btn-text">
                    or <a href="<?= Backend::url('webmaxx/forms/feedbacks') ?>"><?= e(trans('backend::lang.form.cancel')); ?></a>
                </span>
            </div>
        </div>
        */ ?>
